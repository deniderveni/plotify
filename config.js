...
const Section = new Parameter('Section', ["PCS", "Upstream", "Downstream"], 
                                         ["A00", "A01", "A02"]);
const Analyser = new Parameter('Analyser', ["IVal ~ Mu mass", "IVal"], 
                                           ["IValidationAnalyzer_selector", "IValidationAnalyzer"]);
const IniFin = new Parameter('StartOrEnd', ["Start", "End"], 
                                           ["Ini", "Fin"]);
...
const Particle = new Parameter('Particle', [
    ...
    "Neutron", "Proton", "Antiproton", "Kaon-", "Kaon+", "Gamma", "K_L0", "K_S0", "Sigma-", 
    "Sigma0", "Sigma+", "Lambda0", "Alpha", "Deuteron", "Triton"
], [
    "Combined", "11", "-11", "-13", "13", "-211", "211", "111", "2112", "2212", "-2212", 
